    ...
    >
      <Form id="settings-form" >
        <div className="d-flex flex-column p-3">
            ...
            <ErrorMessage component="div" name="firstName" className="errorMessage"/>

            <label htmlFor="lastName">Last Name</label>
            <Field name="lastName" type="text" />
            <ErrorMessage component="div" name="lastName" className="errorMessage"/>

            <label htmlFor="phoneNumber">Phone Number</label>
            <Field name="phoneNumber" type="number" step="1"/>
            <ErrorMessage component="div" name="phoneNumber" className="errorMessage"/>
